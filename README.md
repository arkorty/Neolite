...
You also have the added benefit of becoming a true Vim chad once you start using Neovim instead of those pathetic web browsers (ahem.. VS Code) disguised as IDEs.
